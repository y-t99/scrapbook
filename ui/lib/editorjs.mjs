...
function me(s, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const a = "Editor.js 2.29.0-rc.8", l = `line-height: 1em;
            color: #006FEA;
...
function eo(s, e) {
  ...
  return I(t) ? t(s) : G(t) ? s[t] : (t !== void 0 && T("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function to(s, e) {
...
`);
      ...
      function m(v, g) {
        for (var w = [], E = {}, S = 0; S < v.length; S++) {
          var C = v[S], O = g.base ? C[0] + g.base : C[0], B = { css: C[1], media: C[2], sourceMap: C[3] };
...
`);
          var S = d(v.insertInto + " " + v.insertAt.before);
          w.insertBefore(g, S);
        }
      }
      function A(v) {
      ...
      function H(v, g) {
        ...
        if (g.singleton) {
          var O = h++;
          w = u || (u = M(g)), E = ce.bind(null, w, O, !1), S = ce.bind(null, w, O, !0);
        } else
...
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ce)))) + " */");
          ...
          }.bind(null, w, g), S = function() {
            A(w), w.href && URL.revokeObjectURL(w.href);
          }) : (w = M(g), E = function(B, j) {
      ...
      t.exports = function(v, g) {
        ...
        return p(w, g), function(E) {
          for (var S = [], C = 0; C < w.length; C++) {
            var O = w[C];
            (B = a[O.id]).refs--, S.push(B);
          }
          for (E && p(m(E, g), g), C = 0; C < S.length; C++) {
            var B;
            if ((B = S[C]).refs === 0) {
...
`);
      ...
      function ce(v, g, w, E) {
        var S = w ? "" : E.css;
        if (v.styleSheet)
          v.styleSheet.cssText = J(g, S);
        else {
          var C = document.createTextNode(S), O = v.childNodes;
  ...
  exportAPI(e) {
    const t = ["configuration"], o = () => {
      Object.values(e.moduleInstances).forEach((n) => {
        I(n.destroy) && n.destroy(), n.listeners.removeAll();
      }), Io(), e = null;
      for (const n in this)
